...
var defaultTheme = __webpack_require__(9112);
...
var _utils = __webpack_require__(8956);
...
"use strict";
module.exports = JSON.parse('{"global":{"share_to_facebook":"Share To Facebook","swicth_lang":"Switch Langauge","search":"Search"}}');
...
"use strict";
module.exports = JSON.parse('{"global":{"share_to_facebook":"ចែករំលែកទៅកាន់ Facebook","swicth_lang":"ផ្លាស់ប្ដូរភាសា","search":"ស្វែងរក"}}');
...
function Index() {
  return /*#__PURE__*/react.createElement("div", {
    className: "container"
  }, /*#__PURE__*/react.createElement("h1", null, "Home Page"), /*#__PURE__*/react.createElement(Link, {
    to: "/play"
...
var LANGAUGES = {
  km: __webpack_require__(4787),
  en: __webpack_require__(8976)
};
...
function Play() {
  ...
  var share = function share() {
    canvasRef.current.toBlob(function (imageBlob) {
      ...
      formData.append("image", imageBlob, user.id + ".jpg");
      fetch("/upload", {
        method: "POST",
        body: formData
      }).then(function (res) {
        FB.ui({
          method: 'share',
          href: location.origin + "/?user=" + user.id
        }, function (response) {
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    size: "medium",
    disableElevation: true
  }, translate.global.swicth_lang), /*#__PURE__*/react.createElement("img", {
    src: "/me.jpg"
    ...
    size: "medium",
    disableElevation: true
  }, "GET AUTH"), /*#__PURE__*/react.createElement("div", {
    style: {
      width: '100%',
      overflow: 'scroll'
    }
  }, /*#__PURE__*/react.createElement("pre", null, JSON.stringify(authContext, null, 1))));
}
...
var Drawer = /*#__PURE__*/react.forwardRef(function Drawer(props, ref) {
  ...
  var drawer = /*#__PURE__*/react.createElement(Paper_Paper, (0,esm_extends/* default */.Z)({
...
var SwipeableDrawer = /*#__PURE__*/react.forwardRef(function SwipeableDrawer(inProps, ref) {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(Drawer_Drawer, (0,esm_extends/* default */.Z)({
    ...
    onClose: onClose,
    ref: ref
  }, other)), !disableSwipeToOpen && variant === 'temporary' && /*#__PURE__*/react.createElement(NoSsr_NoSsr, null, /*#__PURE__*/react.createElement(SwipeableDrawer_SwipeArea, (0,esm_extends/* default */.Z)({
    anchor: anchor,
    ref: swipeAreaRef,
...
var Mail = __webpack_require__(2865);
...
;// CONCATENATED MODULE: ./src/components/AppBar/index.js
function AppBar_slicedToArray(arr, i) { return AppBar_arrayWithHoles(arr) || AppBar_iterableToArrayLimit(arr, i) || AppBar_unsupportedIterableToArray(arr, i) || AppBar_nonIterableRest(); }

function AppBar_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function AppBar_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return AppBar_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return AppBar_arrayLikeToArray(o, minLen); }

function AppBar_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function AppBar_iterableToArrayLimit(arr, i) { var _i = arr && (typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"]); if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function AppBar_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
var useStyles = styles_makeStyles(function (theme) {
  return {
    ...
    title: AppBar_defineProperty({
      flexGrow: 1,
      display: 'none'
    }, theme.breakpoints.up('sm'), {
      display: 'block'
    }),
    search: AppBar_defineProperty({
      position: 'relative',
      borderRadius: theme.shape.borderRadius,
      backgroundColor: (0,colorManipulator/* fade */.U1)(theme.palette.common.white, 0.15),
      '&:hover': {
        backgroundColor: (0,colorManipulator/* fade */.U1)(theme.palette.common.white, 0.25)
      },
      marginLeft: 0,
      width: '100%'
    }, theme.breakpoints.up('sm'), {
    ...
    inputInput: AppBar_defineProperty({
...
function SearchAppBar() {
  var _useState = (0,react.useState)(false),
      _useState2 = AppBar_slicedToArray(_useState, 2),
  ...
  var list = function list() {
    ...
    }, /*#__PURE__*/react.createElement(List_List, null, ['Inbox', 'Starred', 'Send email', 'Drafts'].map(function (text, index) {
      return /*#__PURE__*/react.createElement(ListItem_ListItem, {
        button: true,
        key: text
      }, /*#__PURE__*/react.createElement(ListItemIcon_ListItemIcon, null, index % 2 === 0 ? /*#__PURE__*/react.createElement(MoveToInbox/* default */.Z, null) : /*#__PURE__*/react.createElement(Mail/* default */.Z, null)), /*#__PURE__*/react.createElement(ListItemText_ListItemText, {
        primary: text
      }));
    })), /*#__PURE__*/react.createElement(Divider_Divider, null), /*#__PURE__*/react.createElement(List_List, null, ['All mail', 'Trash', 'Spam'].map(function (text, index) {
      return /*#__PURE__*/react.createElement(ListItem_ListItem, {
        button: true,
        key: text
      }, /*#__PURE__*/react.createElement(ListItemIcon_ListItemIcon, null, index % 2 === 0 ? /*#__PURE__*/react.createElement(MoveToInbox/* default */.Z, null) : /*#__PURE__*/react.createElement(Mail/* default */.Z, null)), /*#__PURE__*/react.createElement(ListItemText_ListItemText, {
  ...
  }, /*#__PURE__*/react.createElement(Menu/* default */.Z, null)), /*#__PURE__*/react.createElement(SwipeableDrawer_SwipeableDrawer, {
    open: drawerState,
    onClose: toggleDrawer(false),
    onOpen: toggleDrawer(true)
  }, list()), /*#__PURE__*/react.createElement(Typography_Typography, {
  ...
  }, /*#__PURE__*/react.createElement(Search/* default */.Z, null)), /*#__PURE__*/react.createElement(InputBase_InputBase, {
...
function App() {
  return /*#__PURE__*/react.createElement(translate_context, null, /*#__PURE__*/react.createElement(auth_context, null, /*#__PURE__*/react.createElement(SearchAppBar, null), /*#__PURE__*/react.createElement(BrowserRouter, null, /*#__PURE__*/react.createElement(Switch, null, /*#__PURE__*/react.createElement(Route, {
    path: "/",
    component: pages_Index,
    exact: true
  }), /*#__PURE__*/react.createElement(Route, {
    path: "/play",
    component: pages_Play
  })))));
}
...
(0,react_dom.render)( /*#__PURE__*/react.createElement(src_App, null), document.getElementById("root"));
})();
