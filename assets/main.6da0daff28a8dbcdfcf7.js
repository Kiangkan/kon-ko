...
var LinearProgress = /*#__PURE__*/react.forwardRef(function LinearProgress(props, ref) {
  var classes = props.classes,
      ...
      other = objectWithoutProperties_objectWithoutProperties(props, ["classes", "className", "color", "value", "valueBuffer", "variant"]);
 ...
 false ? 0 : void 0;
/* harmony default export */ const LinearProgress_LinearProgress = (styles_withStyles(styles, {
...
;// CONCATENATED MODULE: ./src/lib/Request.js
var STATE = {
  DONE: 4,
  HEADERS_RECEIVED: 2,
  LOADING: 3,
...
function request(_ref) {
  ...
  return new Promise(function (resovle, error) {
    var request = new XMLHttpRequest();
    request.responseType = "blob";
    request.onprogress = progress;

    request.onreadystatechange = function () {
      if (this.readyState == STATE.DONE && this.statusText == STATUS.OK) resovle(this);
    };
...
function onFinished() {
  ...
  return new Promise(function (resovle) {
    if (_this.readyState == STATE.DONE && _this.statusText == STATUS.OK) {
      console.log(_this);
      resovle(_this);
    }
  });
...
function App() {
  ...
  (0,react.useEffect)(function () {
    request({
      method: "GET",
      url: "https://mef-archive-api.myoptistech.com/docs/download/609ac25e2282fb00ed0e85b8?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjVhMGQ0ZGYyYjAzMTU2MTE4YjI0NTE5MyIsInJvbGUiOnsiX2lkIjoxLCJuYW1lIjoiQWRtaW4iLCJfX3YiOjAsIm5hbWVfa2giOiLhnqLhn5LhnpPhnoDhnoLhn5LhnprhnpThn4vhnoLhn5LhnprhnoQifSwiZW1haWwiOiJhZG1pbkBvcHRpc3RlY2guY29tIiwiaWF0IjoxNjIwOTg2MDIwLCJleHAiOjE2MjEwMDA0MjB9.S9GBy8qbln-34zq1bw38FNf5n9TwNoRdCkJl54PppOI",
      progress: function progress(_progress) {
        setProgress(100 * _progress.loaded / _progress.total);
      }
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, progress ? /*#__PURE__*/react.createElement(LinearProgress_LinearProgress, {
    variant: "determinate",
    value: progress
  }) : null, /*#__PURE__*/react.createElement(BrowserRouter, null, /*#__PURE__*/react.createElement(Switch, null, /*#__PURE__*/react.createElement(Route, {
    path: "/",
